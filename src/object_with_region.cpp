...
ObjectWithRegionNode::ObjectWithRegionNode() : Node("object_with_region_node")
{
...
void ObjectWithRegionNode::detection_callback(const vision_msgs::msg::Detection3DArray::SharedPtr msg)
{
